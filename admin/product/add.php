...
$id = $title = $price=$pricenosale = $number = $thumbnail = $content = $id_category = "";
if (!empty($_POST['title'])) {
    ...
    // if(isset($_POST['pricenosale'])){
    //     $pricenosale=$_POST['pricenosale'];
    //     $pricenosale= str_replace('""','\\"',$pricenosale);
    // }
    if(isset($_POST['sale'])){
        $sale=$_POST['sale'];
