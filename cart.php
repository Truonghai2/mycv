...
<head>
    ...
    <link rel="stylesheet" href="../img/logo.png" rel="icon">
...
<body>
    <div id="wrapper">
        <?php require_once('molde/header.php'); ?>
        <!-- END HEADR -->
        <main >
            <section class="cart">
                <div class="container-top">
                    <div class="panel panel-primary">
                        <div class="panel-heading" >
                            ...
                            <h2 style="padding-top:2rem; font-size:30px;" class="">Giỏ Hàng</h2>
                        </div>
                            ...
                            <tbody>
                                ...
                                foreach ($cartList as $item) {
                                    ...
                                    <tr style="text-align: center;">
                                        ...
                                        <td>' . $item['title'] . '</td>
                                        <td class="b-500 red">' . number_format($item['price'], 0, ',', '.') . '<span> đ</span></td>
                                        <td width="100px">' . $num . '</td>
                                        <td class="b-500 red">' . number_format($num * $item['price'], 0, ',', '.') . '<span> đ</span></td>
                                        <td>
                        ...
                        <p>Tổng đơn hàng: <span class="red bold"><?= number_format($total, 0, ',', '.') ?><span> đ</span></span></p>
